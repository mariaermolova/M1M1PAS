...
for subIdx = subIds
    ...
    for sesId = sesIds
        ...
        load(['W:\Projects\2019-04 M1M1PAS Project\analysis\source_signals\LF\sub-' subId...
        ...
        for runId = runIds
            ...
            save(['W:\Projects\2019-04 M1M1PAS Project\analysis\source_signals\Beamformer\sub-' subId '_task-' taskId '_run-' runId '_Beam'],'leftSM','rightSM')
        end
    end
end
