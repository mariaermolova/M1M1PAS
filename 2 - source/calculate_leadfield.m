%% Calculate leadfields for each subject and session
...
ft_defaults
addpath('W:\Projects\2019-04 M1M1PAS Project\analysis\source_signals\Source ristretta\Matti functions')  
addpath('W:\Projects\2019-04 M1M1PAS Project\analysis\source_signals\Source ristretta\NeoMNE')
%% 
clear
close all

subIds = [1:9,11:17]; %remove one subject with no SIHI
sesIds = [1:4];
...
for subIdx = subIds
    ...
    for sesId = sesIds
        ...
        load(['W:\Projects\2019-04 M1M1PAS Project\analysis\source_signals\elec_realigned\sub-' subId '_task-' taskId '_elec_realigned.mat']) ;
